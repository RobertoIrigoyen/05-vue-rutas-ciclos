...
const routes = [{
    ...
    },
    {
        ...
        name: 'pokemon',
        component: () =>
            import ( /* webpackChunkName: "ListPage" */ '@/modules/pokemon/layouts/PokemonLayout'),
        children: [
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'dbz-characters',
                component: () =>
                    import ( /* webpackChunkName: "ListPage" */ '@/modules/dbz/pages/Characters'),
            },
            {
                path: 'about',
                name: 'dbz-about',
    ...
    },
    {
        path: '/:pathMatch(.*)*',
        component: () =>
            import ( /* webpackChunkName: "NotPageFound" */ '@/modules/shared/pages/NotPageFound')
    }
]
